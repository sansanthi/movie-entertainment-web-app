...
import { Recommend_URL, Image_URL } from "../MovieAPI";

const Recommend = () => {
  console.log("Recommend work");
  ...
  return (
    <section className="recommend-section">
      <h2 className="heading-title">Recommned for you</h2>

      <article className="recommend">
        {recommendMovies.slice(0, 10).map((movie) => {
          return (
